...
class Core_Controller extends CI_Controller
{
  function __construct()
  {
   ...
   // pr($this->config);
    ...
    $authentication_arr = ["login","signup.html","attendance.html","forgot.html","check_company_exit","pdf.html","daily-log","send_email","auto-out-log","send-notification","salary-calc"];
    ...
    /* set config */
    // if(getCompanyId() > 0){
        $config = $this->user_model->get_config_settings();
        if(count($config) > 0){
