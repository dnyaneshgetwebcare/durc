...
$config['base_url'] = 'http://localhost/extra_work/qr_products/';
...
$config['company_logo_with_name'] = "public/img/uploads/company_logo/";
$config['company_logo'] = "public/img/logo.png";
$config['company_name'] = "AROM";
